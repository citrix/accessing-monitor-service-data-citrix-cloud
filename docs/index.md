...
You may obtain the bearer token using the Citrix Cloud APIs. For more information on the steps, see [https://developer.cloud.com/authenticate_api_client.html](https://developer.cloud.com/getting-started)
